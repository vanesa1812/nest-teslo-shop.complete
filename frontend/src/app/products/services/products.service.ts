...
import { delay, forkJoin, map, of, pipe, switchMap, tap, type Observable } from 'rxjs';
...
export class ProductsService {
  ...
  createdProduct(productLike: Partial<Product>, imageFileList?:FileList): Observable<Product>{
    return this.http
